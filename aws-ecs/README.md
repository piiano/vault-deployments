...
This application version is 1.4.1 and is compatible with Vault version 1.6.1 .
...
| <a name="input_pvault_tag"></a> [pvault\_tag](#input\_pvault\_tag) | Pvault tag public image | `string` | `"1.3.1"` | no |
