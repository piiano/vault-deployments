...
| <a name="input_cloudsql_username"></a> [cloudsql\_username](#input\_cloudsql\_username)                                                                                                    | Vault database user | `string` | `"pvault"`                                                                                                                                                                                                                                                                                                                                                                                                                | no |
...
| <a name="input_pvault_license"></a> [pvault\_license](#input\_pvault\_license)                                                                               | Vault server license token | `string` | n/a                                                                                                                                                                                                                                                                                                                                                                                                                       | yes |
...
| <a name="input_pvault_tag"></a> [pvault\_tag](#input\_pvault\_tag)                                                                                           | n/a | `string` | `"1.8.1"`                                                                                                                                                                                                                                                                                                                                                                                                                 | no |
