...
| Bastion       | bastion EC2 instance                          | Optional - For testing purpose                          |
...
| App runner    | Managed AppRunner deployment of Piiano Vault  |                                                         |
...
Before installaing Vault, [obtain your license](https://piiano.com/docs/guides/get-started). Update it in .tfvars file or use as an evironment variable `export TF_VAR_pvault_service_license=<the license>`
...
| <a name="input_create_bastion"></a> [create\_bastion](#input\_create\_bastion) | n/a | `bool` | `true` | no |
